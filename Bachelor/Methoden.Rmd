...
_Signal Level Test:_ Dieser Test vergleicht zwei, aus dem Datensatz, berechnete 
_Polygon Test:_ Hier wird untersucht, ob die Datenpunkte innerhalb des Datensatzes sich im "Uhrzeigersinn" befinden. Dabei wird mit der Formel ((x2 - x1)(y2+y1)) die Summe über den Kanten bestimmt. Bei positiven Amplifikationen erreicht die Summe höhere Werte als bei negativen Amplifikationen. Als Schwellenwert wurde hier empirisch ein Wert von 100 als passender SChwellenwert festgestellt [@Roediger2015].
